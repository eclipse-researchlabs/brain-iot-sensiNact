...
public class ButtonGUI extends JLabel implements MouseListener, ButtonSetterItf {
    ...
    public ButtonGUI(ButtonAdapter listener) {
        super();
        super.setLayout(new BoxLayout(this, BoxLayout.PAGE_AXIS));
        buttonOn = new ImageIcon(ButtonGUI.class.getClassLoader().getResource("images/button/on.png"));
        buttonOff = new ImageIcon(ButtonGUI.class.getClassLoader().getResource("images/button/off.png"));
