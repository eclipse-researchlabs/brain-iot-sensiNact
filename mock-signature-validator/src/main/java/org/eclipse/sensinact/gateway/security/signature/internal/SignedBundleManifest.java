...
public class SignedBundleManifest extends Manifest {
    ...
    public static byte[] getManifestMainAttributesAsBytes(InputStream input) throws IOException {
        byte[] content = IOUtils.read(input);
        return SignedBundleManifest.getManifestMainAttributesAsBytes(content);
    }
